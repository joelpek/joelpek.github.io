...
const Work = () => (
    <div id="work">
        ...
        <ul>
            <li>
                <b>Independent IT & Digital Marketing Consultant</b> |
                Freelancer | Dec '14 - (ongoing)
            </li>
            <li>
                <b>Finnish Elections / City of Espoo</b> | Committee Member |
                '11 - '17
            </li>
            <li>
            ...
            <li>
                <b>HOK-Elanto</b> | Customer Service and Sales Rep | May '07 -
                Feb '15
            </li>
        </ul>
    </div>
...
const Education = () => (
    <div id="education">
        ...
        <ul>
            ...
            <li>
                <b>Metropolia UAS</b> | Bachelor of Engineering (B.E.) | '12 -
                '16
            </li>
            <li>
                <b>Tapiola Upper Secondary School</b> | Matriculation Exam | '06
                - '09
            </li>
        </ul>
    </div>
